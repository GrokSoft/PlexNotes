...
bootstrap.js:304: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:441: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
      $next[0].offsetWidth // force reflow
      ^

bootstrap.js:542: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:637: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
    this.$element[dimension](this.$element[dimension]())[0].offsetHeight
    ^

bootstrap.js:754: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:920: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:999: WARNING - Suspicious code. This code lacks side-effects. Is there a bug?
      if (transition) {
      ^

bootstrap.js:1000: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
        that.$element[0].offsetWidth // force reflow
        ^

bootstrap.js:1115: WARNING - Suspicious code. This code lacks side-effects. Is there a bug?
      if (doAnimate) this.$backdrop[0].offsetWidth // force reflow
      ^

bootstrap.js:1115: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
      if (doAnimate) this.$backdrop[0].offsetWidth // force reflow
                     ^

bootstrap.js:1259: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:1773: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:1882: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:2055: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^

bootstrap.js:2132: WARNING - Suspicious code. The result of the 'getprop' operator is not being used.
        element[0].offsetWidth // reflow for transition
        ^

bootstrap.js:2211: WARNING - Suspicious code. The result of the 'pos' operator is not being used.
+function ($) {
^
...
e;c.fn.affix.noConflict=function(){c.fn.affix=b;return this};c(window).on("load",function(){c('[data-spy="affix"]').each(function(){var a=c(this),b=a.data();b.offset=b.offset||{};null!=b.offsetBottom&&(b.offset.bottom=b.offsetBottom);null!=b.offsetTop&&(b.offset.top=b.offsetTop);d.call(a,b)})})}(jQuery); //# sourceMappingURL=bootstrap.js.map
