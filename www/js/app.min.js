...
templateUrl:"plex-jumbo.html",controller:function(a){a.myInterval=5E3;a.noWrapSlides=!0;a.active=0;a.isCollapsedjControls=!0;var d=a.slides=[],c=0;a.addSlide=function(){d.push({image:"//unsplash.it/"+(600+d.length+1)+"/300",text:["Nice image","Awesome photograph","That is so cool","I love that"][d.length%4],id:c++})};a.randomize=function(){for(var a=[],b=0;b<c;++b)a[b]=b;var e,g=a.length;if(g)for(;--g;)e=Math.floor(Math.random()*(g+1)),b=a[e],a[e]=a[g],a[g]=b;b=0;for(e=d.length;b<e;b++)d[b].id=a.pop()};
for(var b=0;4>b;b++)a.addSlide()},controllerAs:"jumboCtrl"}});e.controller("NotesController",["$scope","$http","$element",function(a,d,c){a.statuses=function(){console.log("Getting statuses from NotesController");return q};a.priorities=function(){console.log("Getting priorities from NotesController");return p};a.categories=function(){console.log("Getting categories from NotesController");return r};a.notes=function(){console.log("Getting notes from NotesController");return n};a.intToString=function(a){return isNaN(a)?
a:parseInt(a)};a.zoom=function(a,d){var c=document.querySelector("#"+a),c=angular.element(c),e=angular.element(d.target);c.hasClass("grow-md")?(e.removeClass("glyphicon-zoom-out"),e.addClass("glyphicon-zoom-in"),c.removeClass("grow-md")):(e.removeClass("glyphicon-zoom-in"),e.addClass("glyphicon-zoom-out"),c.addClass("grow-md"))};a.deleteNote=function(b){d({method:"DELETE",url:"http://localhost:8080/api/notes/"+b,data:a.newNote,headers:{"content-Type":"application/json"}}).success(function(b,c,d,e){b.errors?
alert("Note was NOT deleted:"+JSON.stringify(errors,null,4)):alert("Note was deleted:"+JSON.stringify(b,null,4));console.log("Note delete: "+JSON.stringify(b));a.refreshNotes()})};a.toggleAllNotesCollapse=function(){a.isCollapsedNote=!a.isCollapsedNote};a.isCollapsedNotes=!1;a.isCollapsedNotesAll=!1;a.isCollapsedNote=!0;a.isCollapsedDetails=!1;a.isCollapsedHorizontal=!1;a.isCollapsedList=!1;a.isCollapsedCat=!1}]);e.directive("getSize",function(){return{restrict:"A",link:function(a,d,c){var b=d[0].clientWidth,
...
templateUrl:"notesList.html",controller:"NotesController",controllerAs:"notesListCtrl"}});e.directive("notesDropdown",function(){return{restrict:"E",templateUrl:"notesDropdown.html",controller:"NotesController",controllerAs:"notesDropdownCtrl"}});e.controller("NotesCarouselController",["$scope","$document",function(a,d){a.init=function(c){a.id=c};a.getId=function(){return a.id};this.setCarousel=function(){new h(d,a.id)};a.notes=function(){console.log("Getting notes from NotesCarouselController");
